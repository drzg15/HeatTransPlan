...
class TSPPlot():
    ...
    def draw_deleted_curve(self, heatCascadedeltaH, deletedPocketdict, _temperatures, plottest):
        fig = plt.figure()
    ...
    def draw_total_site_profile(self, site_designation, tstHotH, tstHotTemperatures, tstColdH, tstColdTemperatures, localisation):
        #Wieder aus den ausgegebenen Werten fuer alle Prozesse Temperaturintervalle erstellen und diese dann plotten
        fig, (ax1, ax2) = plt.subplots(1, 2)
  
        fig.suptitle('Total Site Profile ({})'.format(site_designation))
