...
class TemperaturePocketDeletion:
    def __init__(self, hot_utility, heat_cascade, _temperatures):
        self.hot_utility = hot_utility
        self.heat_cascade = heat_cascade
        self._temperatures = _temperatures
        self._options = {'draw': True}

    def delete_double_empty(self,u):
    ...
    def delete_temperature_pockets(self):
            ...
            if self._options['draw'] == True:
                TSPPlot.draw_deleted_curve(self, self.heatCascadedeltaH, self.deletedPocketdict, self._temperatures, plottest)
